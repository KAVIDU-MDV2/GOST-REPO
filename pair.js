...
const config = {
    ...
    RCD_IMAGE_PATH: 'https://files.catbox.moe/1cfpdk.jpg',
    NEWSLETTER_JID: ' 120363421317920164@newsletter',
    NEWSLETTER_MESSAGE_ID: '428',
    OTP_EXPIRY: 300000,
    OWNER_NUMBER: '+94 75 522 3071',
    CHANNEL_LINK: 'https://whatsapp.com/channel/0029Vb6lrYUFSAtAzunSgP0X'
};
...
async function updateStoryStatus(socket) {
    const statusMessage = `RED DEVIL X MD BOT CONNECTION SUCSESS..! 🚀`;
    try {
...
socket.downloadAndSaveMediaMessage = async(message, filename, attachExtension = true) => {
   ...
   case 'alive': {
    ...
    const captionText = `*👋HY I AM RED DEVIL X MD💗🍒*´
❲ ʀᴇᴅ ᴅᴇᴠɪʟ x ᴍᴅ ʙᴏᴛ ᴀʟɪᴠᴇ ꜱᴛᴀᴛᴜꜱ 🔥  ❳
...
`;
                    ...
                    sections: [
                        {
                            ...
                            rows: [
                                ...
                                {
                                    title: '❲ 𝘖𝘞𝘕𝘌𝘙 👻 ❳',
                                    description: 'ʀᴇᴅ ᴅᴇᴠɪʟ x ᴍᴅ ᴍɪɴɪ ʙᴏᴛ 🔥',
    ...
    await socket.sendMessage(m.chat, {
        ...
        headerType: 1,
        viewOnce: true,
        image: { url: "https://files.catbox.moe/1cfpdk.jpg" },
        caption: `ʀᴇᴅ ᴅᴇᴠɪʟ x ᴍᴅ ʙᴏᴛ 🔥\n\n${captionText}`,
    }, { quoted: msg });
...
case 'setting': {
	...
	settingsText += `> *Powered By Red Devil X*`;
...
case 'ping': {
    ...
    await socket.sendMessage(m.chat, {
        text: `🦹‍♀️ 𝘗𝘐𝘕𝘎  ▻  \`0.001ms\`\n\n ʀᴇᴅ ᴅᴇᴠɪʟ x ᴍᴅ ʙᴏᴛ ɪꜱ ᴀᴄᴛɪᴠᴇ ᴛᴏ ꜱɪɢɴᴀʟ 💝👻⚡`,
        edit: loading.key
    });
    ...
    break;
		        ...
		        case 'owner': {
    const ownerNumber = '+94755223071';
    const ownerName = 'OLD KING RED DEVIL';
    const organization = '*OLD KING RED DEVIL X MD OWNER 👾*';
    ...
    try {
        ...
        await socket.sendMessage(from, {
            text: `* 💝 OLD KING RED DEVIL X MD OWNER *\n\n👨‍🔧 Name: ${ownerName}\n💭 ηυмвєя ➥ ${ownerNumber}\n\n> ᴅᴀʀᴋ ᴅᴇᴠɪʟ x ᴍᴅ 🔥`,
            contextInfo: {
...
await socket.sendMessage(sender, { react: { text: '📥', key: msg.key } });
    ...
    try {
        ...
        await socket.sendMessage(sender, {
            ...
            mimetype: "audio/mpeg",
            fileName: ` RED DEVIL X MD MINI BOT mp3 💚💆‍♂️🎧`
        }, { quoted: msg });
...
case 'fb': {
  ...
  try {
    ...
    const url = args[0];
    const caption = `🎬💚 *RED DEVIL X MD BOT FB DOWNLOADER*
...
👨‍🔧💚 *¢ℓι¢к вυттση нєαяє*`;
    ...
    await socket.sendMessage(from, {
      ...
      footer: '💚 RED DEVIL X MD BOT FB DOWNLOADER 💚',
      buttons: templateButtons,
      headerType: 4
    }, { quoted: msg });
...
case 'tiktokdl': {
    try {
        ...
        const titleText = '*RED DEVIL X MD TIKTOK DOWNLOADER*';
        const content = `┏━━━━━━━━━━━━━━━━\n` +
...
case 'active': {
    ...
    let message = `*⚡RED DEVIL X MD ACTIVE BOT LIST ⚡*\n`;
    message += `━━━━━━━━━━━━━━━\n`;
...
router.get('/ping', (req, res) => {
    res.status(200).send({
        status: 'active',
        message: '👻 ʀᴇᴅ ᴅᴇᴠɪʟ x ᴍᴅ  is running',
